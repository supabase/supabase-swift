...
internal enum URLSessionTransportError: Error {
  ...
  case invalidRequestURL(path: String, method: HTTPTypes.HTTPRequest.Method, baseURL: URL)
...
extension URLRequest {
  init(_ request: HTTPTypes.HTTPRequest, baseURL: URL) throws {
...
extension URLSession {
  func bufferedRequest(
    ...
    return try await withTaskCancellationHandler {
      ...
      return (try HTTPTypes.HTTPResponse(response), maybeResponseBody)
    } onCancel: {
      taskBox.withLockedValue { boxedTask in
